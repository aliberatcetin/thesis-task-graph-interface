                ...
                <div id="graph">
                    <GraphView
                        ...
                        renderNodeText={data => {
                            ...
                            return (
                                <foreignObject x='-40' y='-70' width='200' height='200'>
                                    <div className='node'>
                                        <p style={{fontSize: 13}}>{data.title}: {data.task}</p>
                                        <p style={{fontSize: 13}}>input: {data.input}</p>
                                        <p style={{fontSize: 13}}>output: {data.output}</p>
                                        <p style={{fontSize: 13}}>input source: {TYPES[data.inputSource]}</p>
                                    </div>
                                </foreignObject>
                            )
                        }}
